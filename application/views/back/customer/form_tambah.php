                     ...
                     <div class="card-body">
                        <form action="<?= base_url('admin/customer/tambah_aksi') ?>" method="post">
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="nama_depan" id="nama_depan" class="form-control <?= form_error('nama_depan')  ? 'is-invalid' : "" ?>" value="<?= set_value('nama_depan') ?>">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="nama_belakang" id="nama_belakang" class="form-control <?= form_error('nama_belakang')  ? 'is-invalid' : "" ?>" value="<?= set_value('nama_belakang') ?>">
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="no_telepon" id="no_telepon" class="form-control <?= form_error('no_telepon')  ? 'is-invalid' : "" ?>" value="<?= set_value('no_telepon') ?>">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <textarea name="alamat" placeholder="Alamat" class="form-control <?= form_error('alamat')  ? 'is-invalid' : "" ?>" name="alamat" id="" cols="30" rows="5"><?= set_value('alamat', $guest->alamat) ?></textarea>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label for="konfirmasi_pass">Konfirmasi Password <small class="text-danger">*</small></label>
