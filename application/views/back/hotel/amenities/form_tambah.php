       ...
       <section class="content">
          <div class="container-fluid">
             <div class="card shadow">
                ...
                <div class="card-body">
                   <form action="<?= base_url('admin/amenities_tambah_aksi') ?>" method="post" enctype="multipart/form-data">
                      <div class="row">
                         <div class="col-md-6">
                            ...
                            <div class="form-group row">
                               <div class="offset-sm-2 col-sm-10">
                                  <div class="checkbox mt-5">
                                     <label>
                                        Room Only <input type="checkbox" name="only_kamar" class="form-control" value="1" <?php echo ($amenities->room_only == 1) ? 'checked="checked"' : '' ?> />
                                     </label>
                                  </div>
                               </div>
                            </div>
                      ...
                      <div class="row">
                         <div class="col-md-6">
                            <div class="form-group">
                               ...
                               <textarea name="deskripsi" rows="5" id="deskripsi" class="form-control <?= form_error('deskripsi')  ? 'is-invalid' : "" ?>"> <?= set_value('deskripsi') ?></textarea>
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                               ...
                               <div class="custom-file">
                                  <input type="file" name="gambar" class="custom-file-input dropify" id="customFile" value="<?= set_value('gambar'); ?>" data-height="200" required>
