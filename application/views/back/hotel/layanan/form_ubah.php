        ...
        <div class="container-fluid">
           <div class="card shadow">
              <div class="card-header">
                 <h3 class="card-title">Ubah Layanan</h3>
              </div>
              <div class="card-body">
                 <form action="<?= base_url('admin/service_ubah_aksi') ?>" method="post">
                    <div class="row">
                       <div class="col-md-6">
                          <input type="hidden" name="id_layanan" value="<?= $layanan->id_layanan ?>">
                          <div class="col-md-12">
                             <div class="form-group">
                                <label class="col-form-label" for="judul"></i> Nama Service</label>
                                <input type="text" class="form-control <?= form_error('judul')  ? 'is-invalid' : "" ?>" name="judul" id="judul" placeholder="Judul" value="<?= set_value('judul', $layanan->judul) ?>">
                                <?= form_error('judul', '<div class = "text-small text-danger">', '</div>') ?>
                             </div>
                          </div>
                          <div class="col-md-12">
                             <div class="form-group">
                                <label class="col-form-label" for="status"></i> Tipe Bayar</label>
                                <select name="tipe_biaya" class="form-control <?= form_error('tipe_biaya')  ? 'is-invalid' : "" ?>" id="tipe_biaya">
                                   ...
                                   <option value="1" <?= set_select('tipe_biaya', '1'); ?> <?= ($layanan->tipe_biaya == '1') ? 'selected="selected"' : ''; ?>>Per Orang</option>
                                   <option value="2" <?= set_select('tipe_biaya', '2'); ?> <?= ($layanan->tipe_biaya == '2') ? 'selected="selected"' : ''; ?>>Per Malam</option>
                                   <option value="3" <?= set_select('tipe_biaya', '3'); ?> <?= ($layanan->tipe_biaya == '3') ? 'selected="selected"' : ''; ?>>Biaya Tetap</option>
                                </select>
                          ...
                          <div class="col-md-12">
                             <div class="form-group">
                                ...
                                <input type="number" class="form-control <?= form_error('biaya')  ? 'is-invalid' : "" ?>" name="biaya" id="biaya" placeholder="Biaya" value="<?= set_value('biaya', $layanan->biaya) ?>">
                          ...
                          <div class="col-md-12">
                             <div class="form-group">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="status" value="1" <?= ($layanan->status == 1) ? 'checked="checked"' : '' ?> /> Aktif
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="status" value="2" <?= ($layanan->status == 2) ? 'checked="checked"' : '' ?> /> Tidak aktif
                          ...
                          <div class="col-md-12">
                             <div class="form-group">
                                ...
                                <textarea name="deskripsi" rows="5" id="deskripsi" class="form-control redactor <?= form_error('deskripsi')  ? 'is-invalid' : "" ?>"> <?= set_value('deskripsi', $layanan->deskripsi) ?></textarea>
                                ...
                                <div class="form-group">
                                   ...
                                   <select name="tipe_kamar[]" class="form-control multiselect" multiple="multiple">
                                      <?php foreach ($tipe_kamar as $new) { ?>
                                         <option value="<?= $new->id_tipe_kamar ?>" <?= (in_array($new->id_tipe_kamar, $kamar_service)) ? 'selected="selected"' : '' ?>><?= $new->judul ?></option>
                                      <?php } ?>
                                   </select>
                                </div>
                             </div>
