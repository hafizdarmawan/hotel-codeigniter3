       ...
       <section class="content">
          <div class="container-fluid">
             <div class="card shadow">
                ...
                <div class="card-body">
                   <form action="<?= base_url('admin/banners/ubah_aksi') ?>" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                         <input type="hidden" name="id_banner" value="<?= $banners->id_banner ?>" id="">
                         <label class="col-form-label" for="nama"></i> Nama</label>
                         <input type="text" class="form-control <?= form_error('nama')  ? 'is-invalid' : "" ?>" name="nama" id="nama" placeholder="Nama" value="<?= set_value('nama', $banners->nama) ?>">
                         <?= form_error('nama', '<div class = "text-small text-danger">', '</div>') ?>
                      </div>
                      <div class="form-group">
                         <label class="col-form-label" for="judul"></i>Judul</label>
                         <input type="text" class="form-control" name="judul" id="judul" placeholder="Heading" value="<?= set_value('judul', $banners->judul) ?>">
                      </div>
                      <div class="form-group">
                         <label class="col-form-label" for="deskripsi"></i>Deskripsi</label>
                         <textarea name="deskripsi" id="deskripsi" class="form-control"><?= set_value('deskripsi') ?><?= $banners->deskripsi ?></textarea>
                      ...
                      <div class="row">
                         <div class="form-group">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="status" value="1" <?= ($banners->status == 1) ? 'checked="checked"' : '' ?> /> Aktif
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="status" value="0" <?= ($banners->status == 0) ? 'checked="checked"' : '' ?> /> Tidak Aktif
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                               ...
                               <div class="custom-file">
                                  <input type="file" name="gambar" class="custom-file-input dropify" id="customFile" value="<?= set_value('gambar'); ?>" data-height="300">
                                  <input type="hidden" name="image_lama" value="<?= $banners->gambar ?>">
