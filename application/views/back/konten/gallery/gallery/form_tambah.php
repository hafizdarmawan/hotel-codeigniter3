          ...
          <div class="container-fluid">
             <div class="card shadow">
                <div class="card-header">
                   <h3 class="card-title">Tambah Galleri</h3>
                </div>
                <div class="card-body">
                   <form action="<?= base_url('admin/gallery/tambah_aksi') ?>" method="post">
                      <div class="form-group">
                         <label class="col-form-label" for="judul"></i>Judul</label>
                         <input type="text" class="form-control <?= form_error('judul')  ? 'is-invalid' : "" ?>" name="judul" id="judul" placeholder="Judul" value="<?= set_value('judul') ?>">
