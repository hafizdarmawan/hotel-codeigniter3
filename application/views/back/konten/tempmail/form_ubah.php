   ...
   <section class="content">
      <div class="container-fluid">
         <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
               <form action="<?= base_url('admin/tempmail/ubah_aksi') ?>" method="post">
                  <div class="form-group">
                     <label class="col-form-label" for="nama"></i> Name</label>
                     <input type="hidden" name="id_tempmail" value="<?= $tempmail->id_tempmail?>">
                     <input type="text" class="form-control <?= form_error('nama')  ? 'is-invalid' : "" ?>" name="nama" id="nama" placeholder="Nama" value="<?= set_value('nama', $tempmail->nama) ?>">
                     <?= form_error('nama', '<div class = "text-small text-danger">', '</div>') ?>
                  </div>
                  <div class="form-group">
                     <label class="col-form-label" for="subject"></i> Subject</label>
                     <input type="text" name="subject" class="form-control <?= form_error('subject')  ? 'is-invalid' : "" ?>" id="subject" placeholder="Subject" value="<?= set_value('subject', $tempmail->subject) ?>">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <textarea name="content" required class="form-control redactor" rows="30" placeholder="Content"><?= set_value('content', $tempmail->content)?></textarea>
