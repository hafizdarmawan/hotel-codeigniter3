                           ...
                           <div class="form-group">
                              ...
                              <?php if ($_GET['filter'] == 1) : ?>
                                 <div class="text-center">
                                    <p>Dari:<?= $_GET['date_from'] ?> Sampai : <?= $_GET['date_to'] ?> Status: <?= $_GET['status'] ?></p>
                                 </div>
                              <?php elseif ($_GET['filter'] == 2) : ?>
                                 <div class="text-center">
                                    <p>Bulan:<?= $_GET['bulan'] ?> Tahun: <?= $_GET['tahun'] ?> Status: <?= $_GET['status'] ?></p>
                                 </div>
                              <?php elseif ($_GET['filter'] == 3) : ?>
                                 <div class="text-center">
                                    <p>Tahun: <?= $_GET['tahun'] ?> Status: <?= $_GET['status'] ?></p>
                                 </div>
                              <?php endif ?>
                              <div class="mt-4">
                                       ...
                                       <tbody>
                                          ...
                                          <?php foreach ($transaksi as $data) : ?>
                                             <tr>
                                                ...
                                                <td><?= $data->bank ?></td>
                                                <td><?= $data->waktu ?></td>
                                                <td align="center"> <?php if ($data->status_kode == 200) : ?>
                                                      <a href="" class="btn btn-success">Lunas</a>
                                                   <?php elseif ($data->status_kode == 201) : ?>
                                                      <a href="" class="btn btn-warning">Pendding</a>
...
<script>
   ...
   var chart = AmCharts.makeChart("weekchart", {
      ...
      "theme": "light",
      "marginRight": 70,
      "dataProvider": <?= json_encode($weekdata) ?>,
      "valueAxes": [{
         "axisAlpha": 0,
         "position": "left",
         "title": "Grafik Minggu"
   ...
   var chart = AmCharts.makeChart("monthchart", {
      ...
      "theme": "light",
      "marginRight": 70,
      "dataProvider": <?= json_encode($monthdata) ?>,
      "valueAxes": [{
         "axisAlpha": 0,
         "position": "left",
         "title": "Grafik Bulan"
   ...
   var chart = AmCharts.makeChart("yearchart", {
      ...
      "theme": "light",
      "marginRight": 70,
      "dataProvider": <?= json_encode($yeardata) ?>,
      "valueAxes": [{
         "axisAlpha": 0,
         "position": "left",
         "title": "Grafik Tahun"
   ...
   //    "theme": "light",
   //    "marginRight": 70,
   //    "dataProvider": <?= json_encode($customdata) ?>,
   //    "valueAxes": [{
   //       "axisAlpha": 0,
   //       "position": "left",
