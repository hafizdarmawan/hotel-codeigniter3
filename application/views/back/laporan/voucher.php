               ...
               <div class="card card-outline card-info shadow">
                  <div class="card-header p-2">
                     <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#custom" data-toggle="tab">Laporan </a></li>
                           ...
                           <div class="form-group">
                              <form method="get" action="">
                                 ...
                                 <div class="mt-2">
                                    ...
                                    <a href="<?= base_url('admin/laporan/voucher'); ?>" class="btn btn-warning shadow">Reset Filter</a>
