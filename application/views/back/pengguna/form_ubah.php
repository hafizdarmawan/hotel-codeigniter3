         ...
         <div class="container-fluid">
            <div class="card shadow">
               <div class="card-header">
                  <h3 class="card-title">Ubah Pengguna Sistem</h3>
               </div>
               <div class="card-body">
                  <form action="<?= base_url('admin/ubah_aksi') ?>" method="post" enctype="multipart/form-data">
                     <div class="row">
                        <input type="hidden" name="id_user" value="<?= $pengguna->id_user ?>">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="col-form-label" for="nama_depan"></i> Nama depan</label>
                              <input type="text" class="form-control <?= form_error('nama_depan')  ? 'is-invalid' : "" ?>" name="nama_depan" id="nama_depan" placeholder="Nama depan" value="<?= set_value('nama_depan', $pengguna->nama_depan) ?>">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control <?= form_error('nama_belakang')  ? 'is-invalid' : "" ?>" name="nama_belakang" id="nama_belakang" placeholder="Nama belakang" value="<?= set_value('nama_belakang', $pengguna->nama_belakang) ?>">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control <?= form_error('username')  ? 'is-invalid' : "" ?>" name="username" id="username" placeholder="Username" value="<?= set_value('username', $pengguna->username) ?>">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="email" class="form-control <?= form_error('email')  ? 'is-invalid' : "" ?>" name="email" id="email" placeholder="@Example.com" value="<?= set_value('email', $pengguna->email) ?>">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select name="jenis_kelamin" class="form-control <?= form_error('jenis_kelamin')  ? 'is-invalid' : "" ?>" id="jenis_kelamin">
                                 ...
                                 <option value="<?= '1'; ?>" <?= set_select('jenis_kelamin', '1'); ?> <?= ($pengguna->jenis_kelamin == '1') ? 'selected="selected"' : ''; ?>>Laki-laki</option>
                                 <option value="<?= '0'; ?>" <?= set_select('jenis_kelamin', '0'); ?> <?= ($pengguna->jenis_kelamin == '0') ? 'selected="selected"' : ''; ?>>Perempuan</option>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control <?= form_error('no_telepon')  ? 'is-invalid' : "" ?>" name="no_telepon" id="no_telepon" placeholder="+62" value="<?= set_value('no_telepon', $pengguna->no_telepon) ?>">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control <?= form_error('tempat_lahir')  ? 'is-invalid' : "" ?>" name="tempat_lahir" id="tempat_lahir" placeholder="Tempat lahir" value="<?= set_value('tempat_lahir', $pengguna->tempat_lahir) ?>">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control <?= form_error('tanggal_lahir')  ? 'is-invalid' : "" ?>" name="tanggal_lahir" id="tanggal_lahir" placeholder="" value="<?= set_value('tanggal_lahir', $pengguna->tanggal_lahir) ?>">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <textarea name="alamat" id="alamat" class="form-control <?= form_error('alamat')  ? 'is-invalid' : "" ?>"><?= $pengguna->alamat ?> <?= set_value('alamat') ?></textarea>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select name="level_users" class="form-control <?= form_error('level_users')  ? 'is-invalid' : "" ?>" id="level_users">
                                 ...
                                 <option value="1" <?= set_select('level_users', '1'); ?> <?= ($pengguna->level_users == '1') ? 'selected="selected"' : ''; ?>>Admin</option>
                                 <option value="2" <?= set_select('level_users', '2'); ?> <?= ($pengguna->level_users == '2') ? 'selected="selected"' : ''; ?>>Resepsionis</option>
                              </select>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select name="status_users" class="form-control <?= form_error('status_users')  ? 'is-invalid' : "" ?>" id="status_users">
                                 ...
                                 <option value="1" <?= set_select('status_users', '1'); ?> <?= ($pengguna->status_users == '1') ? 'selected="selected"' : ''; ?>>Aktif</option>
                                 <option value="0" <?= set_select('status_users', '0'); ?> <?= ($pengguna->status_users == '0') ? 'selected="selected"' : ''; ?>>Non-aktif</option>
                              </select>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="custom-file">
                                 ...
                                 <input type="hidden" name="foto_lama" value="<?= set_value($pengguna->foto) ?>">
