...
<body style="width: 100% !important; height: 100%; -webkit-text-size-adjust: none; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; background-color: #FFF; color: #333; margin: 0;" bgcolor="#FFF">
   <span class="preheader" style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">{{invite_sender_name}} with {{invite_sender_organization_name}} has invited you to use [Product Name] to collaborate with them.</span>
      ...
      <tr>
         <td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                        ...
                        <tr>
                           <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;">
                              <div class="f-fallback">
                                 ...
                                 <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">{{invite_sender_name}} with {{invite_sender_organization_name}} has invited you to use [Product Name] to collaborate with them. Use the button below to set up your account and get started:</p>
                                 <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                 ...
                                 <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">If you have any questions for {{invite_sender_name}}, you can reply to this email and it will go right to them. Alternatively, feel free to <a href="mailto:{{support_email}}" style="color: #3869D4;">contact our customer success team</a> anytime. (We're lightning quick at replying.) We also offer <a href="{{live_chat_url}}" style="color: #3869D4;">live chat</a> during business hours.</p>
                                 <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">Welcome aboard,
                                    <br />The [Product Name] Team</p>
                                 <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;"><strong>P.S.</strong> Need help getting started? Check out our <a href="{{help_url}}" style="color: #3869D4;">help documentation</a>.</p>
                                 <!-- Sub copy -->
